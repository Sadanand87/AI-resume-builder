...
import { FaGithub, FaLinkedin, FaInstagram, FaFacebook, FaTwitter, FaCircle, FaInfoCircle } from "react-icons/fa";
...
function HomePage() {
  ...
  const handleClick = () => {
    window.open(
      "https://github.com/Sadanand87/Ai-Resume-Builder.git",
      "_blank"
    );
  };
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 p-5">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-3">
              <a href="https://github.com/Sadanand87" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900">
                <FaGithub className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/in/sadanand8789/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900">
                <FaLinkedin className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/sadanand_kumarmodi?utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900">
                <FaInstagram className="w-5 h-5" />
              </a>
              <a href="https://www.facebook.com/sadanandkumar.modi.71/?viewas=100000686899395" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900">
                <FaFacebook className="w-5 h-5" />
              </a>
              <a href="https://twitter.com/sadanandkumar" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900">
